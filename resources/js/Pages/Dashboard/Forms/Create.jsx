...
export default function CreateForm() {
  ...
  const [templateBlocks, setTemplateBlocks] = React.useState([]);
  ...
  return (
    <DashboardLayout>
      <Head title="إنشاء نموذج جديد" />
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-800 mb-2">إنشاء نموذج جديد</h2>
